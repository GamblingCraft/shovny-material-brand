...
const { data: page } = useFetch<CmsPageData>('/api/cms/pages/production', {
  key: 'cms-page-production',
  default: () => getFallbackPage('production')
})

useSeoMeta({
  title: () => `${page.value?.seoTitle ?? 'Производство'} | BRAND`,
